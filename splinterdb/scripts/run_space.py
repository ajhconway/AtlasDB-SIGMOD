...
#lookup_load.run("/home/XXXX/sosp-data/splinter")
#lookup.run("/home/XXXX/sosp-data/splinter")
...
#space = Benchmark("space", ["load", "zipf_update"], [16], [kvellsize], 256, 24, 100, 0, log = 0)
#space.run("/home/XXXX/sosp_data/splinter")

space = Benchmark("space", ["load", "zipf_update"], [16], [medium], 256, 24, 1024, 0, log = 0)
space.run("/home/XXXX/sosp_data/splinter")
