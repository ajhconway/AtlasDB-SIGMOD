...
#ycsb = Benchmark("lookup_temp", ["load"], [16], [kvellsize], dbsize, 24, 100, 0)
...
ycsb = Benchmark("scan", ["scan1", "scan10", "scan100", "scan1000", "scan10000", "scan100000"], [32], [kvellsize], dbsize, 24, 100, 1)
ycsb.run("/home/XXXX/sosp_data/splinter")

#ycsb = Benchmark("scan", ["scan1", "scan10", "scan100", "scan1000", "scan10000", "scan100000"], [32], [medium], dbsize, 24, 1024, 1)
#ycsb.run("/home/XXXX/sosp_data/splinter")
