...
#ifndef POISON_FROM_PLATFORM_IMPLEMENTATION
/*
 * These are platformized or normally illegal, but the platformization
 * implementation needs to use these symbols.  The C file should define
 * the #ifdef symbol above before including poison.h
 */
