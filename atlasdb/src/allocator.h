...
static inline platform_status
allocator_get_super_addr(allocator *al, splinter_id spl_id, uint64 *addr)
{
   return al->ops->get_super_addr(al, spl_id, addr);
}

static inline platform_status
allocator_alloc_super_addr(allocator *al, splinter_id spl_id, uint64 *addr)
{
...
static inline void
allocator_remove_super_addr(allocator *al, splinter_id spl_id)
{
