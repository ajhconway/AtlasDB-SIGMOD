...
// BEGIN MAYBE NOT OK TO INCLUDE EVERYWHERE
// Are these ok to include everywhere?
// These were only included in a few places before
#include <execinfo.h>
#include <unistd.h>
// END MAYBE NOT OK TO INCLUDE EVERYWHERE
...
// These definitons are needed for avlTree in the user space build.
#ifndef AVLTREE_DEFINES
#  define AVLTREE_DEFINES
   typedef char Bool;
